                    ...
                    <div class="col-md-12">
                        <div class="p-20">
                            ...
                            <div class="form-group">
                                {!! Form::label('title','Tên Partner*',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-10">
                            ...
                            <div class="form-group">
                                {!! Form::label('hinh-slider','Hình Partner *',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-10">
                                    {!! Form::file('fileImg',['class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('hinh-slider','Hình Partner hiện tại',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-10">
                                    <img src="{{asset('upload/partner/'.$list->images)}}" style="width: 300px" />
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('Ẩn hiện','Ẩn / Hiện Partner',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-10">
