                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            ...
                            <div class="box-price-titrang">
                                <div class="row">
                                    <div class="giasp col-xs-8 col-sm-6">
                                        @if($data->discount != 0)
                                            <span class="strike compare-price" itemprop="price">{{number_format($data->prices).'đ'}}</span>
                                            <strong class="sale-price" itemprop="price">{{number_format($data->discount).'đ'}}</strong>
                                            @elseif($data->prices == 0)
                                            <strong class="sale-price" itemprop="price">Liên hệ</strong>
                                            @elseif($data->prices != 0)
                                            <strong class="sale-price" itemprop="price">{{number_format($data->prices).'đ'}}</strong>
                            ...
                            <div class="">
                                <ul class="list_thongtin">
                                    <li><span>Nhà sản xuất:</span> <a href="#"></a></li>
                                    <li><span>Chất liệu:</span> <a href="#">Gỗ xoan</a></li>
                                    <li><span>Màu sắc:</span> <a href="#">Vàng</a></li>
                                    <li><span>Kích thước:</span> <a href="#"></a></li>
                                </ul>
                            </div>
                            <div class="line"></div>
                            ...
                            <button type="submit" value="Mua hàng" class="btn muahang btn-cart">Mua hàng ngay<br/><span>Giao tận nơi, nhận hàng nhận tiền</span>
                            </button>
